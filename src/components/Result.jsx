...
export function Result({ questionsData, countQuestions, RestartGame }) {
  const countRightAnswers = questionsData.reduce(
    (prevValue, questionData) =>
      prevValue + (questionData.question.correct == questionData.answer ? 1 : 0),
    0,
  );
